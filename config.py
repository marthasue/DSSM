...
flags.DEFINE_boolean("train_eval", True, "Whether train and evaluate model or not")
...
flags.DEFINE_string("query_model_path", "./host_model/", "Saved model.")
flags.DEFINE_string("doc_model_path", "./guest_model/", "Saved model.")
...
flags.DEFINE_integer("doc_max_char_length",50, "max_char_sentence_length")
