...
def parse_exp(example):
    ...
    features_def["host_char"] = tf.io.FixedLenFeature([FLAGS.query_max_char_length], tf.int64)
    features_def["guest_char"] = tf.io.FixedLenFeature([FLAGS.doc_max_char_length], tf.int64)
